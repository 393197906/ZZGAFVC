...
(function (window) {
    ...
    var WebVideoCtrl = (function () {
        ...
        var m_options = {
            ...
            szOcxClassId: "clsid:E7EF736D-B4E6-4A5A-BA94-732D71107808", //IE插件的ocxID，默认为基线的ID
            szMimeTypes: "application/hwp-webvideo-plugin",              //非IE的mimetypes, 默认为基线值
        ...
        var m_szVersion = "<?xml version='1.0' encoding='utf-8'?><FileVersion>" +
            "<Platform name='win32'>" +
            "<npWebVideoPlugin.dll>3,0,5,56</npWebVideoPlugin.dll>" +
            "<WebVideoActiveX.ocx>3,0,5,56</WebVideoActiveX.ocx>" +
            "<PlayCtrl.dll>6,5,2,40</PlayCtrl.dll>" +
            "<StreamTransClient.dll>1,1,2,11</StreamTransClient.dll>" +
            "<SystemTransform.dll>2,3,0,10</SystemTransform.dll>" +
            "<NetStream.dll>1,0,5,57</NetStream.dll>" +
            "<HCNetSDK.dll>4,2,6,7</HCNetSDK.dll>" +
            "<ShowRemConfig.dll>3,1,2,14</ShowRemConfig.dll>" +
            "</Platform>" +
            "</FileVersion>";
        ...
        this.I_Login = function (szIP, iProtocol, iPort, szUserName, szPassword, options) {
            ...
            if(PROTOCOL_DEVICE_ISAPI == cgiType) {
                ...
                //如果是PSIA登录，则必然是用户自己选择的，登录失败直接返回错误即可
                szAuth = m_utilsInc.Base64.encode(szUserName + ":" + szPassword);
                cgiType = PROTOCOL_DEVICE_PSIA;
                cgiInstance = m_PSIAProtocol;
                var newOptions = {
        ...
        this.I_GetDownloadStatus = function (iDownloadID) {
            return m_pluginOBJECT.HWP_GetDownloadStatus(iDownloadID);
        };
        ...
        this.I_ExportDeviceConfig = function (szIP) {
            ...
            if(iIndex != -1) {
                ...
                return deviceInfo.oProtocolInc.exportDeviceConfig(deviceInfo);
            }
        };
